                    ...
                    <div className="story-column">
                        <div className="column-container">
                            <div className="tittle-container">
                                <p className="story-tittle">{tittle1}</p>
                            </div>
                            <div className="story-text-container">
                                <p className="story-text">{text1}</p>
                            </div>
                        </div>
                    </div>


                    {/*//aqui va la otra columna*/}
                    <div className="story-column">
                        <div className="column-container">
                            <div className="tittle-container">
                                <p className="story-tittle">{tittle2}</p>
                            </div>
                            <div className="story-text-container">
                                <p className="story-text">{text2}</p>
                            </div>
                        </div>
                    </div>
                </div>
